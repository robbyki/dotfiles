...
-- zoxide
set_keymap("n", "<leader>cd", ":lua require'telescope'.extensions.zoxide.list{}<CR>", opts)

-- harpoon
set_keymap('n', '<leader>hm', [[<cmd>lua require("harpoon.ui").toggle_quick_menu()<CR>]], opts)
set_keymap('n', '<leader>ha', [[<cmd>lua require("harpoon.mark").add_file()<CR>]], opts)
set_keymap('n', '<leader>hc', [[<cmd>lua require("harpoon.mark").clear_all()<CR>]], opts)
...
set_keymap('n', '<Leader>sl', [[<cmd>lua require('telescope.builtin').live_grep()<CR>]], opts)
...
set_keymap('n', '<Leader>tt', [[<cmd>lua require('telescope.builtin').builtin()<CR>]], opts)
...
--set_keymap('n', '<Leader>tv'  [[<cmd>lua require("metals.tvp").toggle_tree_view()<CR>]], opts)
...
set_keymap("n", "<leader>fo", ":copen<cr>", opts) -- open quickfix window
set_keymap("n", "<leader>fc", ":cclose<cr>", opts) -- close quickfix window
