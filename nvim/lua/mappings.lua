...
wk.register({
  ...
  ["<leader>h"] = {
    ...
    l = { "<Cmd>lua require'hop'.hint_lines()<CR>", "hop by line" },
    w = { "<Cmd>lua require'hop'.hint_words()<CR>", "hop by word" },
  },
  ["<leader>l"] = {
    name = "+lsp",
    ...
    S = { "<Cmd>lua vim.lsp.buflsp_definitionse()<CR>", "lsp_definitions" },
  },
  ["<leader>m"] = {
    name = "+metals",
