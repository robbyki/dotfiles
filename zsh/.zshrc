...
#export PATH="$HOME/.local/bin:$HOME/.local/share/coursier/bin:/opt:/opt/bin:/usr/local/bin:/usr/bin:${JAVA_HOME}/bin:${MVN_HOME}/bin:${GIT_HOME}/bin:${GO_HOME}/bin:${HOME}/.cargo/bin:${IBMCLOUD_HOME}:${HOME}/tools/lua-language-server/bin/Linux:$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin:${PATH}"
...
#alias lfrc='vi $HOME/.config/lf/lfrc'
...
alias vpu="$EDITOR +'PlugUpdate --sync' +qa"
alias am='alsamixer'
...
# uses alias vv='vi -u ~/.config/nvim/init.vim'
...
z() { vi $HOME/.zshrc; source $HOME/.zshrc; }
